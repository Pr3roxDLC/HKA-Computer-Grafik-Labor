...
{
  static SDL_Point saucer_points[] = {{-16, -6}, {16, -6}, {40, 6}, {-40, 6}, {-16, 18}, {16, 18}, {40, 6}, {16, -6}, {8, -18}, {-8, -18}, {-16, -6}, {-40, 6}};
  ...
  SDL_SetRenderDrawColor(renderer, static_cast<float>((int)saucer->get_position()[0] * 4 % 255), static_cast<float>((int)saucer->get_position()[1] * 4 % 255), 255, 255);
  SDL_RenderDrawLines(renderer, points.data(), points.size());
  SDL_SetRenderDrawColor(renderer, 255, 255, 255, 255);
}
